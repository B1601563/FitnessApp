 ...
 * @author celine_yin
 */
public class ZLogInDialog extends javax.swing.JDialog {
    private HELPFit helpfit;
    private HFGUI hfgui;
    /**
     * Creates new form LogInDialog
     */
    public ZLogInDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Log In");
        setLocation(850, 450);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZLogInDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ZLogInDialog dialog = new ZLogInDialog(new javax.swing.JFrame(), true);
