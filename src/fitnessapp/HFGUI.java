...
/**
 * HFGUI is the user interface for user to interact with the HELPFit Application system
 * @author B1601563
 */
public class HFGUI extends javax.swing.JFrame{
    ...
    private void newFileOptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newFileOptionActionPerformed
        ...
        if (hf != null) {
            ...
            if (n == JOptionPane.YES_OPTION) {
                result = FileHandling.saveToFile(this, hf);
                
                if (result == null) {
                    JOptionPane.showMessageDialog(this, "Save command cancelled.", 
                            "Save cancelled", JOptionPane.WARNING_MESSAGE);
                } else {
                JOptionPane.showMessageDialog(this, "File successfully saved as " + result + ".", 
    ...
    private void saveFileOptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveFileOptionActionPerformed
        ...
        // pass this JFrame and the HELPFit object to save
        // returns file name if saved, null if cancelled
        String result = FileHandling.saveToFile(this, hf);
        if (result == null) {
            JOptionPane.showMessageDialog(this, "Save command cancelled.", 
                    "Save cancelled", JOptionPane.WARNING_MESSAGE);
        } else {
    ...
    /**
     * A method to login as a User when loginBtn is clicked
     * @param evt 
     */
