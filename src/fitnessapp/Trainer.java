...
public class Trainer extends User implements Serializable {
     ...
     * @param time time of session.
     * @param fee fee of session.
     * @param classType class type of group session
     * @param maxParticipants maximum number of participants for this session
     * @return PersonalTraining if the training is added successfully
     */
     ...
     * @return true if review successfully added to trainerReviews list
     */
