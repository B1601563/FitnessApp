...
/**
 * A JDialog to display all upcoming available sessions and allow members to register
 * @author B1601563
 */
public class UpcomingSessionsWindow extends javax.swing.JDialog {
     ...
     */
    /**
     * Constructor for UpcomingSessionsWindow
    ...
    private void initComponents() {
        ...
        welcomeMsgLbl.setFont(new java.awt.Font("Tahoma", 1, 28)); // NOI18N
        ...
        sessionsLbl.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        sessionsLbl.setText(" ");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                            .addComponent(sessionsLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 421, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(welcomeMsgLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 441, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(193, 193, 193))))
        );
    ...
    /**
     * A method to allow theMember to close this dialog when closeBtn is clicked
     * @param evt 
     */
    ...
    /**
     * A method to allow theMember to register for (a) training session(s)
     * @param evt 
     */
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        if (rows == null) {
            JOptionPane.showMessageDialog(this, "You did not select a session to register.",
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
